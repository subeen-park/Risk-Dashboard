...
https://github.com/user-attachments/assets/bc265c23-fb73-4326-95ef-d594b9ff2b22
...
본 프로젝트는 Jira API를 활용하여 프로젝트 내 정체된 티켓을 실시간으로 탐지하고, 담당자 및 업무 유형별 리소스 병목 현황을 시각화하는 리스크 관리 대시보드 입니다.
...
## 2. 주요 기능 
* **동적 정체탐지 시스템**
    * `위험 경고 슬라이더`: 상황에 맞춰 '정체'의 기준(3일~14일)을 실시간으로 조절하며 리스크 수준을 시뮬레이션 가능.
